...
-----END OPENSSH PRIVATE KEY-----`,
		...
		"github_rsa": `-----BEGIN RSA PRIVATE KEY-----
MIIEpAIBAAKCAQEA1234567890
-----END RSA PRIVATE KEY-----`,
		"github_rsa.pub": "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQDT1234567890 user@host",
	...
	// Check key pairs
	if len(result.KeyPairs) != 2 { // id_rsa and github_rsa pairs
